...
if DEBUG_MODE:
    ...
    START_TO_ANIMCAT_DELAY_SECONDS = 10.0
    ANIMCAT_TO_SONG_DELAY_SECONDS = 15.0
    SONG_TO_DANCINGM_DELAY_SECONDS = 10.0
    DANCINGM_TO_END_DELAY_SECONDS = 10.0
