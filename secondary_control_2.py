...
class GamepadControl(object):
    ...
    def __init__(self, world, start_in_autopilot, joystick_id=1, deadzone=0.08, steer_sensitivity=1.0):
        import pygame
...
class GnssSensor(object):
    def __init__(self, parent_actor):
        ...
        # We need to pass the lambda a weak reference to self to avoid circularreference.
        weak_self = weakref.ref(self)
...
class RearCamera(object):
    def __init__(self, parent_actor, width=320, height=240, fps=10):
        ...
        # VERY IMPORTANT:
        # do not start camera => rear_view.py is responsible for starting it
        self.sensor.stop()
...
def game_loop(args):
    ...
    try:
        ...
        pygame.display.set_caption(f"CARLA Manual Control gamepad (joy #1)")
...
def main():
    ...
    argparser.add_argument(
        ...
        metavar='NAME',
        default='hero2',
        help='actor role name (default: "hero2")')
    argparser.add_argument(
        '--gamma',
        default=2.2,
        type=float,
