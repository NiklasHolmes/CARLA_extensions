...
def main():
    ...
    try:
        ...
        blueprint = world.get_blueprint_library().find('vehicle.dodge.charger_2020')

        if blueprint.has_attribute('color'):
            #color = random.choice(blueprint.get_attribute('color').recommended_values)
            #colorlist = blueprint.get_attribute('color').recommended_values
            #print(colorlist)
            blueprint.set_attribute('color', '90,0,0')
